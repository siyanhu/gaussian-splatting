cd /home/siyanlinux/Documents/datasets/HongKong/full_arcore/colmap_rebuild_sfm/
...
do
    ...
    colmap model_converter --input_path "${scn}"/dense/workspace/sparse/0 \
    --output_path "${scn}"/dense/workspace/sparse/0 \
    --output_type TXT
